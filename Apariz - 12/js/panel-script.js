...
const states = form.querySelector('#state');
const city = form.querySelector('#city');
const inputGroup = form.querySelectorAll('.input-group');
const states_input = form.querySelector('input[name="state_destination"]');
const city_input = form.querySelector('input[name="city_destination"]');

states.addEventListener('change' , function(e){
    let valueItem_State = this.querySelector(`option[value="${this.value}"]`).textContent;
    states_input.value = valueItem_State;
})

city.addEventListener('change' , function(e){
    let valueItem_city = this.querySelector(`option[value="${this.value}"]`).textContent;
    city_input.value = valueItem_city;
})


    form.addEventListener('submit' , function(e){
        if(inputGroup[2].children[0].value == ""){
            e.preventDefault();
            inputGroup[2].children[0].classList.add('input-active')
            inputGroup[2].children[1].classList.add('active')
        }
        if(inputGroup[3].children[0].value == ""){
            e.preventDefault();
            inputGroup[3].children[0].classList.add('input-active')
            inputGroup[3].children[1].classList.add('active')
        } 
        if(inputGroup[4].children[0].value == ""){
            e.preventDefault();
            inputGroup[4].children[0].classList.add('input-active')
            inputGroup[4].children[1].classList.add('active')
        }
        if(inputGroup[5].children[0].value == ""){
            e.preventDefault();
            inputGroup[5].children[0].classList.add('input-active')
            inputGroup[5].children[1].classList.add('active')
        }
        if(states_input.value == ""){
            e.preventDefault();
            inputGroup[0].children[0].classList.add('input-active')
            inputGroup[0].children[1].classList.add('active')
        }
        if(city_input.value == ""){
            e.preventDefault();
            inputGroup[1].children[0].classList.add('input-active')
            inputGroup[1].children[1].classList.add('active')
        }
